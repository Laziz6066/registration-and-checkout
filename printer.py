...
class ServerApp:
    ...
    def process_payment(self, is_payment_received, payment_method):
        connection = sqlite3.connect('service_records.db')
    ...
    def print_data(self):
        ...
        data_to_print = "\x1B\x45         OBI ZAM-ZAM MED\n\n" \
                        "FIO: {}\n\n" \
                        "Telefon raqam: {}\n\n" \
                        "Xizmat turi: {}\n\n" \
                        "Xizmat narxi: {}\n\n" \
                        "Sana: {}\n\n".format(
                            self.data_dict.get("name"),
                            self.data_dict.get("phone_number"),
                            self.data_dict.get("service_category"),
                            self.data_dict.get("service_price"),
                            formatted_date
                        )
        ...
        try:
            ...
            win32print.WritePrinter(hPrinter, data_to_print.encode())
